...
namespace Fase {
    ...
    Menu::Botao::Texto Fase::textoPontuacao = Menu::Botao::Texto(pGrafico->carregarFonte("fonte/menuColocacao.ttf"), "", 32);
    Menu::Botao::Texto Fase::textoTempo = Menu::Botao::Texto(pGrafico->carregarFonte("fonte/menuColocacao.ttf"), "", 32);
