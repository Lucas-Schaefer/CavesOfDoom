...
namespace Fase {
    ...
    void Fase1::criarFundo() {
        fundo.addCamada("imagens/Fase1/fase1background1.png", 0.0f);
        fundo.addCamada("imagens/Fase1/fase1background2.png", 0.1f);
        fundo.addCamada("imagens/Fase1/fase1background3.png", 0.3f);
        fundo.addCamada("imagens/Fase1/fase1background4.png", 0.5f);
    }
    ...
    void Fase1::criarMapa1() {
        ...
        if (i == 2) {
            ...
            criarEspinho(sf::Vector2f(3480.0f, 175.0f), sf::Vector2f(80.0f, 25.0f));
        }
        if (i == 3) {
