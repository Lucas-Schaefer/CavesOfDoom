...
namespace Menu {
    ...
    MenuCarregarJogo::MenuCarregarJogo() :
        MenuPrincipal(IDs::IDs::menu_carregar_jogo, "CARREGAR JOGO", 45), gerenciadorArquivo()
    {
    ...
    void MenuCarregarJogo::inicializarCards() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            std::string caminhoArquivoEntidades = "arquivos/SalvarJogada/SalvarEntidade/salvar" + std::to_string(i + 1) + ".txt";
            std::string caminhoArquivoFase = "arquivos/SalvarJogada/SalvarFase/salvar" + std::to_string(i + 1) + ".txt";
            std::string caminhoImagem = "arquivos/SalvarJogada/SalvarImagem/salvar" + std::to_string(i + 1) + ".png";
